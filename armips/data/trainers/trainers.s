...
trainerdata 20, "Falkner"
    ...
    party 20
        ...
        ball ITEM_POKE_BALL
        setivs 0, 31, 0, 31, 0, 0 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 0, 0, 0, 0
        nature NATURE_NAIVE
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
...
trainerdata 63, "Lyra"
    trainermontype TRAINER_DATA_TYPE_MOVES | TRAINER_DATA_TYPE_ITEMS | TRAINER_DATA_TYPE_ABILITY | TRAINER_DATA_TYPE_BALL | TRAINER_DATA_TYPE_IV_EV_SET | TRAINER_DATA_TYPE_NATURE_SET | TRAINER_DATA_TYPE_ADDITIONAL_FLAGS
...
trainerdata 151, "Erin"
    ...
    party 151
        ...
        abilityslot 0
        level 31
        monwithform SPECIES_VIVILLON, 12 // river Vivillon
        item ITEM_ZOOM_LENS
        move MOVE_SLEEP_POWDER
...
trainerdata 161, "Sayo"
    ...
    party 161
        ...
        abilityslot 0
        level 42
        monwithform SPECIES_NINETALES, 1 //alolan ninetales
        item ITEM_NONE
        move MOVE_MYSTICAL_FIRE
        move MOVE_EXTRASENSORY
        move MOVE_DAZZLING_GLEAM
...
trainerdata 487, "Petrel"
    ...
    party 487
       // mon 0
        ...
        ability ABILITY_FILTER
        ball ITEM_ULTRA_BALL
        setivs 31, 0, 31, 31, 20, 20 // hp, atk, def, spd, spatk, spdef
        setevs 0, 0, 100, 100, 0, 0
        nature NATURE_BOLD
        shinylock 0
        additionalflags 0 // no further entries data will be read, but needs to be here as the trainer data structure specifies additionalflags
        ballseal 0
